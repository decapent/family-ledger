...
let createHost() =
    WebHostBuilder()
        ...
        .Configure(Action<IApplicationBuilder> Decapent.FamilyLedger.Api.App.configureApp)
        .ConfigureServices(Action<IServiceCollection> Decapent.FamilyLedger.Api.App.configureServices)
